...
using System.Text;
using BotControllerProj.Source.Constants;
using Microsoft.EntityFrameworkCore;

namespace BotControllerProj
{
    public class HelperDataBase
    {
        private static string default_connection = @"Server=(localdb)\mssqllocaldb;Database=GoalBotDB;Trusted_Connection=True;";
